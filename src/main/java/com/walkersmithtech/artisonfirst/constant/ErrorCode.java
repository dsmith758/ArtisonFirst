...
public enum ErrorCode
{
	...
	// PERSON PROFILE ERRORS
	PRODUCT_NOT_FOUND( new ServiceException( "PROD_01", "Product record not found.", HttpStatus.NOT_FOUND ) ),
	PRODUCT_MISSING_ID( new ServiceException( "PROD_02", "Product ID is missing.", HttpStatus.UNPROCESSABLE_ENTITY ) ),
	PRODUCT_RECORD_NULL( new ServiceException( "PROD_03", "The provided record is null.", HttpStatus.UNPROCESSABLE_ENTITY ) ),
	PRODUCT_DESCRIPTION_MISSING( new ServiceException( "PROD_04", "Product description is missing.", HttpStatus.UNPROCESSABLE_ENTITY ) ),
	PRODUCT_COMPANY_MISMATCH( new ServiceException( "PROD_05", "The company doesn't have access to this product.", HttpStatus.NOT_FOUND ) ),
